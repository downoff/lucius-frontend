// ... (all your existing imports and NavLink component)

export default function AppLayout() {
    // ... (all your existing state and useEffect logic)
                    ...
                    <div>
                        <p className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-4">Settings</p>
                         <nav className="flex flex-col gap-2">
                            ...
                            <NavLink to="/referrals" isSettings={true}>Refer a Friend</NavLink> {/* <-- NEW LINK */}
                        </nav>
                    </div>
                </aside>
