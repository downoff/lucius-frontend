        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <Card className="w-full max-w-4xl mx-auto bg-slate-800/50 border-slate-700 text-white">
                <CardHeader>
                    ...
                    <CardDescription>Plan your content in advance. Posts will be sent automatically to your connected X/Twitter account. This is a Pro feature.</CardDescription>
                </CardHeader>
                <CardContent>
